    ...
    return (
        <>
            <div className={cn (
                ...
                isMobile ? "fixed left-0 top-0 min-h-screen" : "relative",
                isMobile && "z-40",
                !isMobile && "md:block",
                ...
                {/* Sidebar Header */}
                <div className={cn("p-6 transition-all duration-500 ease-in-out", isCollapsed && "md:p-4")}>
                    <div className="flex items-center mt-3 mb-14">
                        ...
                        className="absolute right-2 top-2 hover:bg-transparent transition-transform duration-500 ease-in-out"
                        >
                            <X className="!h-5 !w-5"/>
                        </Button>
                        )}
                    ...
                    <div className="space-y-6 py-4">
                        {dashboardRoutes.filter((route) => route.roles.includes(role)).map((route) => {
                            ...
                            return (
                                ...
                                >
                                    <route.icon className="h-5 w-5 transition-transform duration-500 ease-in-out"/>
                                    <span className={cn(
