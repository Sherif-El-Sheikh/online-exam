...
const variantStyles: Record<StyledInputVariant, string> = {
    ...
    search:
    " h-10 sm:h-12 md:h-14 rounded-[1.3rem] border-none shadow-search py-4 px-8 max-[375px]:px-5 sm:pl-14 text-sm/[100%] md:text-base/[100%] lg:text-lg/[100%] max-[375px]:placeholder:text-[0.675rem] placeholder:text-xs/[100%] sm:placeholder:text-sm/[100%] md:placeholder:text-base/[100%] lg:placeholder:text-lg/[100%] focus-visible:ring-1 focus-visible:ring-submain font-poppins font-normal",
    diploma:
...
const VariantInput = React.forwardRef<HTMLInputElement, VariantInputProps>(
    ...
    return (
        <div className="relative">
            ...
            {variant === "search" && (
            <SearchIcon className="absolute max-[375px]:left-1 left-2 sm:left-4 top-1/2 h-4 w-4 sm:h-5 sm:w-5 -translate-y-1/2 transform text-blue-700 lg:h-6 lg:w-6" />
            )}
