...
export default async function middleware(req: NextRequest) {
  ...
  if (token) {
    ...
    if (
      ...
      // Create a fake/random query parameter // What is the use of this key?
    ...
    // If admin tries to access user dashboard // Admins should be able to access user dashboard
    if (
  ...
  // Attach the full current URL as callbackUrl // Well done!
