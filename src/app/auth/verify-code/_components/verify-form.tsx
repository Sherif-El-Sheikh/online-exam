...
import { resendCodeAction } from "../_actions/resend-code.action";
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        {/* Have An Account */}
        <p className="mb-6 mt-4 text-end font-poppins text-sm font-normal lg:text-base">
          ...
          {isResendDisabled ? (
            ...
            <Button
              variant="ghost"
              className="mx-2 text-main hover:bg-transparent hover:text-main"
